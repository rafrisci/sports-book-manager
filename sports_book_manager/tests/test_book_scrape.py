...
TS_2 = bs.BookScraper(r'https://nj.pointsbet.com/sports',
                      {'NBA': r'/basketball/NBA'})
TS_2.update_html_elements(drive_path=r'C:/Windows/chromedriver_win32/'
                          'chromedriver.exe',
                          ancestor_container='.facf5sk', event_row=".f1oyvxkl",
...
class TestBookScraper(unittest.TestCase):
    ...
    def test_update_elements(self):
        ...
        conditions
        """
        self.assertTrue(TS.update_html_elements('faf5he', '3irhs', 'qod93',
                                                ...
                                                r'www.google.com',
                                                r'C:\chromedrive'))
        self.assertTrue(TS.update_html_elements('.f4fshe', '.hales', '.32hdn',
                                                '.q3hkd', '.bioewon'))
    ...
    def test_retrieve_sports_book(self):
        ...
        """
        self.assertTrue(TS_2.retrieve_sports_book('NBA'))
